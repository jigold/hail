...
azure_disks = {'P': sortedcontainers.SortedSet(key=lambda disk: disk.size_in_gib),
...
for family in azure_disk_families:
    for disk_number, storage_gib in azure_disk_number_to_storage_gib.items():
        ...
        azure_disks[family].add(AzureDisk(disk_name, storage_gib))
