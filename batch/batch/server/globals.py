...
def _gs_log_path(instance_id, batch_id, job_id, task_name):
    return f'{instance_id}/{batch_id}/{job_id}/{task_name}/job.log'


async def write_gs_log_file(thread_pool, instance_id, batch_id, job_id, task_name, log):
    path = _gs_log_path(instance_id, batch_id, job_id, task_name)
...
async def delete_gs_log_file(thread_pool, instance_id, batch_id, job_id, task_name):
    path = _gs_log_path(instance_id, batch_id, job_id, task_name)
    try:
