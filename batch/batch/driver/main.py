...
''')
        ...
        agg_billing_project_resources = {record['billing_project']: json_to_value(record['resources'])
                                         async for record in agg_billing_project_resources}  # pylint: disable=bad-continuation
        ...
        assert attempt_by_batch_resources == agg_batch_resources_2, (attempt_by_batch_resources, agg_batch_resources_2)
        assert attempt_by_job_resources == agg_job_resources, (attempt_by_job_resources, agg_job_resources)
        assert job_by_batch_resources == agg_batch_resources_2, (job_by_batch_resources, agg_batch_resources_2)
        assert batch_by_billing_project_resources == agg_billing_project_resources, (batch_by_billing_project_resources, agg_billing_project_resources)
