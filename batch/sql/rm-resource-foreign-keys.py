...
async def main():
    ...
    try:
        ...
        await delete_foreign_key_constraint(db, db_name, 'aggregated_billing_project_resources', 'resources', ['resource'])
        await delete_foreign_key_constraint(db, db_name, 'aggregated_batch_resources', 'resources', ['resource'])
        await delete_foreign_key_constraint(db, db_name, 'aggregated_job_resources', 'resources', ['resource'])
    finally:
