...
ALTER TABLE user_pool_resources ADD FOREIGN KEY (`pool`) REFERENCES pools(id) ON DELETE CASCADE;
...
ALTER TABLE batches_pool_staging ADD FOREIGN KEY (`pool`) REFERENCES pools(id) ON DELETE CASCADE;
...
ALTER TABLE batch_pool_cancellable_resources ADD FOREIGN KEY (`pool`) REFERENCES pools(id) ON DELETE CASCADE;
