...
class PR(gear.github.PR):
    def __init__(self, number, title, source_repo, source_sha, target_branch, author, labels):
        super().__init__(number, title, source_repo, source_sha, target_branch, author, labels)
    ...
    def update_from_gh_json(self, gh_json):
        ...
        self.source_repo = gear.github.Repo.from_gh_json(head['repo'])
    ...
    def from_gh_json(gh_json, target_branch):
        ...
        return PR(gh_json['number'],
                  gh_json['title'],
                  gear.github.Repo.from_gh_json(head['repo']),
                  head['sha'],
                  target_branch,
                  gh_json['user']['login'],
