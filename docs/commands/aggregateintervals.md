...
:-: | ---
`interval` | genomic interval, see the [representation docs](intro.html#Representation) for details
`global` | global annotation
`variants` | Variant [aggregable](intro.html#aggregables).  Aggregator namespace below.
